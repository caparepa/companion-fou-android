 ...
 * Use the [AccountInventoryFragment.newInstance] factory method to
...
class AccountInventoryFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment AccountInventoryFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            AccountInventoryFragment().apply {
